package com.scm.spring.jwt.aop;
...
import com.scm.spring.jwt.model.LoggingSaver;
import com.scm.spring.jwt.repository.LoggingSaverRepository;
...
public class LoggingAdvice {
	...
	@Pointcut("execution(* com.scm.spring.jwt.controllers.*.*(..) )")
